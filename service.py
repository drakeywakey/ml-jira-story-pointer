...
query = jira.search_issues('project = LTC AND issuetype = Story AND "Story Points" != null AND "Story Points" >= 1 AND "Story Points" <= 5 AND createdDate < 2020-01-01',
                             json_result=True,
                             maxResults=1000,
...
model = RandomForestClassifier(random_state=0).fit(X_train_tfidf, y_train)
